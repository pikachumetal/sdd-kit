...
| `sdd-templates` | Las 12 plantillas canónicas (spec, plan, tasks, walkthrough, patch, data-model, research, feedback, release-notes, environments, capability) y el script `Build-EstimationLog.ps1`, que `sdd-end-task` y `sdd-end-patch` ejecutan desde el kit para regenerar el estimation-log del proyecto |
