...
5. **Estructura**: `.docs/sdd/` completa + plantillas del kit (`sdd-templates`; si el kit no está accesible, carpeta con nota pendiente) + `estimation.md` y `estimation-log.md` vacío + `specs/` vacía. ¿Changelog? — preguntar, o dejar como decisión pendiente.
