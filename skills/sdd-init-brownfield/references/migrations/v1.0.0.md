...
1. **`funcional.md` → `capabilities/legacy.md`.** Si existe `.docs/sdd/funcional.md`: **gate** — `git mv .docs/sdd/funcional.md .docs/sdd/capabilities/legacy.md` y añadir al principio del fichero:
