...
5. **Estructura**: `.docs/sdd/` con:
   ...
   - ¿Changelog? — preguntas 2 y 3 del paso 3 (o decisión pendiente); si sí, `changelog.md` calcando `changelog-template.md`, y ¿también novedades para el cliente? (`client-changelog.md` calcado de `client-changelog-template.md`, alimentado por `sdd-end-release` desde las release notes).
