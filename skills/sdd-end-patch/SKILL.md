...
2. **Commit de cierre** — un solo commit sobre el del fix: `patch.md` con su hash y el tiempo, más changelog, roadmap y estimation-log si existen. El patch queda en dos commits, fix y cierre ([commit-milestones.md](../sdd-start-task/references/commit-milestones.md)).
