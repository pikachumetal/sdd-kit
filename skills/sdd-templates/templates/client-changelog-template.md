# Novedades para el cliente — <producto>

> Audiencia: el CLIENTE. Acumulado de lo que ya ha recibido, versión a versión, la más reciente arriba.
> Cada sección se **deriva** de las release notes de esa versión (`releases/vX.Y.Z/release-notes.md`):
...
## vX.Y.Z — <fecha de entrega> — <título de las release notes>

### Resumen

<el Resumen de las release notes, tal cual>

### Novedades

- **Para <rol/área>**: <outcome, tal cual en las release notes>.
