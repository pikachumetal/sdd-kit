...
> la lee `sdd-roadmap` al preparar la siguiente. Borra los bloques de ayuda (`>`) al redactar.
...
> Peticiones que contradicen un supuesto de `capabilities/<capability>.md` o de `mission.md`. El documento lo
