...
Cierre **ligero** de un hotfix: el subconjunto de `sdd-end-task` sin la ceremonia de una feature. Ligero no significa opcional — son seis pasos y caben en minutos.
...
1. **`hotfix.md` finalizado** — commit hash real, verificación con el smoke real (distinguiendo lo verificado por ti de lo reportado por el usuario) y tiempo invertido. Nunca en blanco.
...
- La tabla de hotfixes del roadmap no tiene la fila de este hotfix.
- `hotfix.md` sin commit hash o con el tiempo en blanco.
...
| "Ya está todo en el hotfix.md" | El `hotfix.md` documenta; el changelog y el roadmap indexan. Sin ellos, el hotfix es invisible. |
