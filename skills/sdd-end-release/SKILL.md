...
6. **Colapsar el roadmap** — ANTES de sustituir nada, rescata los pendientes vivos de la sección de la
   ...
   `walkthrough.md` con lo que le toca y su fila pasa a `✅`; la que no menciona sigue `🧪` y el resumen de
   cierre la lista. Estados del roadmap: [control-profiles.md](../sdd-start-task/references/control-profiles.md).
