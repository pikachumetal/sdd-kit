...
| `subagent-driven-development` | **Es el default del kit.** La ejecución en línea es la excepción, y la declara el plan por task con su motivo. Al despachar, las "Restricciones globales" del plan viajan en el encargo del subagente. Sus **rulings** («Rulings, not stalls») valen para salir del plan sin cambiar la spec —un fichero de «NO se tocan», otro orden, un fix del hilo principal—: no se para, se registra y se sigue. Un cambio a la spec aprobada es un **desvío**, no un ruling: sigue la fila «Desvío» del perfil vigente (`control-profiles.md`). Todo commit del hilo principal entra en el alcance de la revisión de la task en curso o, si no queda ninguna abierta, en la final. «Rulings I made», del informe final de la skill, alimenta «Decisiones tomadas sin el dev-lead» del walkthrough. |
