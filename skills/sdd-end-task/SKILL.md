...
12. **Mensaje final** — el último mensaje del cierre. Lo que el cierre tiene que decir se reúne aquí, aunque haya nacido en un paso anterior. En este orden, y solo lo que tenga contenido:
   ...
   2. Las decisiones tomadas sin el dev-lead: relee la sección «Decisiones tomadas sin el dev-lead» del walkthrough, aunque la escribiera otra sesión, y nombra cada una en una línea. Si dice «_Ninguna_», se omite.
