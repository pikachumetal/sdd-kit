...
**Factor de calibración** (ratio mediano real/estimado, 64 artefactos): **0.59** · media 0.67

- p25–p75: 0.38–0.9
- p80: 0.97 — para comprometer una fecha, multiplica la estimación por el p80: así cubre 4 de cada 5 artefactos.
- Dentro de ±25 %: 28 % · sobreestimadas: 66 % · infraestimadas: 6 %
- Error absoluto (h): media 0.87 · mediana 0.6
- Tendencia (mediana de las 10 primeras frente a las 10 últimas): 0.33 frente a 0.56
...
| 1.0.0 | 19 | 16.55 | 0.58 | — |
| 1.1.0 | 3 | 2.3 | 0.8 | — |
| sin publicar | 41 | 47.35 | 0.64 | 142.67 |
