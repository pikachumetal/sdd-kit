...
- 2026-09-25 — 20260924-220849-task-0061-local-config — ADDED Las preferencias personales viven en `sdd-kit.local.json`, fuera de git
- 2026-09-25 — 20260924-220849-task-0061-local-config — ADDED Una clave no admitida en el fichero local se ignora con aviso
- 2026-09-25 — 20260924-220849-task-0061-local-config — ADDED `sdd-config` enseña la configuración antes de preguntar
- 2026-09-25 — 20260924-220849-task-0061-local-config — ADDED `sdd-config` pregunta una clave por turno, con la recomendada primero
- 2026-09-25 — 20260924-220849-task-0061-local-config — ADDED `sdd-config` escribe solo lo respondido, en el fichero que toca
