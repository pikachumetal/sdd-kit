...
- 2026-09-21 — task 0002 — ADDED El ticket de mejora del kit vive en `.docs/sdd/kit-feedback/`
- 2026-09-21 — task 0002 — ADDED El ticket se escribe para un agente, no para una persona
- 2026-09-21 — task 0002 — ADDED «Sin hallazgos» es una salida válida
- 2026-09-21 — task 0002 — ADDED El ticket no lleva el dominio del cliente
- 2026-09-21 — task 0002 — ADDED El hallazgo separa el hueco del kit del error del ejecutor
- 2026-09-21 — task 0002 — ADDED El cierre de una task y el de un patch ofrecen el ticket en la misma sesión
