...
lane: patch
id: 20260923-074153-patch-0036-disparador-vago
task: 0036
mode:
date: 2026-09-23
---

# Ticket para el kit — patch 0036: el aviso final no se cumple desde el paso 0, y el bloque de tiempo del patch no tiene sitio para el coste de sujetos
...
### 1. Una obligación del mensaje final escrita en el paso 0 no se cumple
...
### 2. `patch-template.md` §5 no tiene línea para el coste de sujetos
...
### 3. La rama del patch no sigue `feature/<id>` cuando el worktree ya existía
...
- **Marqué en línea dos piezas de la fila 0015** con el corchete `**[Patch 0036, …: saldada — …]**` delante de cada una, fuera del recuento de filas saldadas. Es la tercera forma que la fila 0015 pide para `roadmap-template.md` (0035 §1); es su segundo uso sin plantilla.
...
- `Get-NextSddId.ps1` devolvió 0036 sin choque con el otro worktree abierto (`feature/fix-01-2`).
- El pre-commit con la suite entera: los dos commits pasaron 355/0.
