...
| 4 | **v0.6.0 — alineación con superpowers 6.3.0 y el estado del arte** (alcance acordado 2026-09-07). T1 [alineación](specs/20260907-151234-task-0000-alineacion-superpowers/spec.md): mapeo vías→carriles, spike en consult, restricciones globales en el plan, versión validada y vigilancia · T2 progressive disclosure de las skills largas (absorbe el ítem 2) · T3 workflow y ejecución: `subagent-driven-development` por defecto con política de modelos forzada desde el plan, TDD, code review, cierre en `develop`. **v0.7.0**: entorno por worktree (contrato + scripts por proyecto, referencia Alybo) y `sdd-init-brownfield` con ideas de OpenSpec + `funcional.md` vivo (el kit tampoco lo tiene: dogfooding) | 🔄 T1 en curso |
