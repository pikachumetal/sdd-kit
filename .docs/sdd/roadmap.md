...
| 2 | Estreno real: instalar en un proyecto del equipo y ciclar las primeras tareas | ⏳ pendiente |
| 3 | v0.2.0 tras el estreno: REFACTOR con la fricción real + pasada de recorte de skills largas (con re-test, Art. I) | ⏳ backlog |

## Backlog

- `sdd-end-bundle` — cierre a nivel release/bundle (módulo opcional; solo proyectos que agrupan releases).
...
| El propio kit aún no ha ciclado ninguna tarea con su flujo (`.docs/sdd/specs/` vacía) — el dogfooding empieza con el próximo cambio no trivial | — |
