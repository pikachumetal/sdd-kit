...
| T15 | [Release pequeña primero y smoke por tramo](specs/20260909-172400-task-0000-release-pequena/spec.md): línea «smoke: fecha · N hallazgos» en la release colapsada | hackaton 2026-09-09 | ✅ cerrada 2026-09-09 — [walkthrough](specs/20260909-172400-task-0000-release-pequena/walkthrough.md). RED 2/2: `sdd-start-release` ya propone un núcleo de dos o tres ítems en la primera release; sin guidance en el paso 2 |
| T16 | [Tests RED escritos por el hilo principal antes de despachar](specs/20260909-173929-task-0000-tests-red-hilo/spec.md): paso 6 de `sdd-start-task`, cabecera del implementador en `encargo-revision.md`, campo `Tests RED` en `plan-template` | hackaton 2026-09-09 | ✅ cerrada 2026-09-09 — [walkthrough](specs/20260909-173929-task-0000-tests-red-hilo/walkthrough.md). RED 0/2 (el implementador escribía los tests), GREEN 2/2 en origen, cobertura por THEN, contrato en el encargo y tests intactos |
| T17 | [Las cinco reglas que el agente decide al azar si nadie las escribe](specs/20260909-180422-task-0000-reglas-de-capacidad/spec.md): sección «Reglas de la capacidad» en `funcional-template`, subsección en `spec-template`, lente dominio con las cinco, fusión por nombre, entrevista de `sdd-init-*` con las cinco por nombre y constitution con «Reglas de producto» | hackaton 2026-09-09 | ✅ cerrada 2026-09-09 — [walkthrough](specs/20260909-180422-task-0000-reglas-de-capacidad/walkthrough.md). RED: spec 3/5 con tope inventado (5 y 10), entrevista 1/5; GREEN: spec 5/5 con tope de la constitution, entrevista 5/5 por nombre (4 sujetos). Estrena la entrevista simulada con dev-lead Haiku |
| T18 | [Changelog de cliente además del técnico](specs/20260909-194633-task-0000-changelog-cliente/spec.md): `changelog-cliente-template.md`, pregunta en la entrevista de `sdd-init-*`, índice; «smoke: pendiente» en el roadmap colapsado | decisión del dev-lead en el cierre (2026-09-09) | ✅ cerrada 2026-09-09 — [walkthrough](specs/20260909-194633-task-0000-changelog-cliente/walkthrough.md). RED 2/2: con el fichero delante, `sdd-end-release` ya lo deriva de las release notes; sin paso nuevo |
