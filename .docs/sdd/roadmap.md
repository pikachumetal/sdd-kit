...
| T14 | Comentarios que citan documentos: regla en el Art. X (un comentario nunca referencia constitution, spec, task o funcional), línea fija en Restricciones globales de `plan-template` y punto explícito en `encargo-revision.md` para el revisor. RED §4.3 de [research-hackaton.md](releases/v0.6.0/research-hackaton.md) (110 comentarios con cita en los dos retos; con la regla escrita, 4 violaciones cazadas por la review) | hackaton 2026-09-09 | ⏳ lite |
