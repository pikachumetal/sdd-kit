...
Los cambios no triviales del kit pasan por su propio flujo: `sdd-start-feature` → spec → plan → implementación → `sdd-end-feature`, con artefactos en `.docs/sdd/specs/`. Los fixes pequeños deterministas, por el carril patch.
