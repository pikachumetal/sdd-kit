...
└── .docs/
    ...
    └── sdd/                     (artefactos SDD del propio kit — dogfooding)
        └── funcional/           (verdad viva por capacidad: un fichero por sustantivo del dominio, fusionado desde el delta de cada spec)
```
