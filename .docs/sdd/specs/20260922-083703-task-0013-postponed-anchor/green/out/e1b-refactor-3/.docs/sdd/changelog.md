...
- **task 0009** — `libres` y `reservar` rechazan una franja horaria mal formada con un mensaje de error, en vez de operar con ella. → [ref](specs/20260921-090000-task-0009-slot-format/)
