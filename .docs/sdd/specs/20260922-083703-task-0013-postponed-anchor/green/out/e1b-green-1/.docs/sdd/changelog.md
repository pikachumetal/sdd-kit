...
- **Task 0009** — Una franja horaria mal formada en `libres` o `reservar` ya no da salas libres falsas: se rechaza con un mensaje claro. → [ref](specs/20260921-090000-task-0009-slot-format/)
