...
- `libres` y `reservar` rechazan una franja horaria mal formada con un mensaje de error, en vez de consultar o reservar con datos inválidos. [task 0009](specs/20260921-090000-task-0009-slot-format/)
