...
- **task 0009** — Una franja horaria mal formada en `libres` o `reservar` se rechaza con mensaje de error, en vez de devolver resultados incorrectos. → [ref](specs/20260921-090000-task-0009-slot-format/)
