...
- **Task 0009** — Validación del formato de franja horaria (`HH:MM-HH:MM`) en `libres` y `reservar`, con mensaje de error claro. → [ref](specs/20260921-090000-task-0009-slot-format/)
