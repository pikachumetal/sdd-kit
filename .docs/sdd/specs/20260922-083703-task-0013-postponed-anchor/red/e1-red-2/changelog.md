...
- Validación del formato de la franja horaria (`HH:MM-HH:MM`) en `libres` y `reservar`, con mensaje de error en castellano. [task 0009](specs/20260921-090000-task-0009-slot-format/)
