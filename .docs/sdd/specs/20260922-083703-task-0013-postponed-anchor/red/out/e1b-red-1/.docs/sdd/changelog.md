...
- Una franja horaria mal escrita ya no devuelve salas libres que no lo están: `libres` y `reservar` la validan y muestran un error claro. [task 0009](specs/20260921-090000-task-0009-slot-format/)
