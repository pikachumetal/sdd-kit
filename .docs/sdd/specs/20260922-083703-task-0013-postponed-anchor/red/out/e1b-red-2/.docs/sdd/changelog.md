...
- Una franja horaria mal escrita en `libres` o `reservar` ya no consulta ni reserva: devuelve un mensaje de error claro. [task 0009](specs/20260921-090000-task-0009-slot-format/)
