...
> **Tras el RED (`tests/release-flow-red.md`):** se **saltan** el Step 3, el Step 4 y la parte de bump del Step 6. El baseline ya cierra sin apertura, propone la versión con motivo, usa el tooling o no crea fichero y omite el acta sin fuente. Se **aplican** el Step 1, el Step 2, el Step 5, el Step 6 (gate y lista de tickets), el Step 7 y el Step 8. El test del hilo tiene tres aserciones: se retira la del bump.
