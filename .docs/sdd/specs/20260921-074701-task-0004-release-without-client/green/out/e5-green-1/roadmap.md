...
Reserva recurrente semanal, salas libres por franja y corrección de la cancelación entre días. [changelog](changelog.md)

smoke: 2026-09-21 · 3 hallazgos (`node --test` con 0 tests; `node src/app.js` con `libres 10:00-12:00`, `reservar --cada-semana` y `cancelar` solo imprime «salas»; 0 corregidos en la release)
