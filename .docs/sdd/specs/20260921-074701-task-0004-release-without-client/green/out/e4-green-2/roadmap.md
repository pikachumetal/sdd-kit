...
Reserva recurrente semanal, salas libres por franja y la cancelación que respeta el día. [changelog](changelog.md)

smoke: 2026-09-21 · 2 hallazgos (`node --test` con 0 tests; invocados `libres 10:00-12:00` y `reservar --cada-semana`, ambos imprimen solo `salas`; 0 corregidos en la release)
