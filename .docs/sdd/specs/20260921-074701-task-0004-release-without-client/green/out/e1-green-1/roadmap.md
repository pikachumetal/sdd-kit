...
smoke: 2026-09-21 · 3 hallazgos (`node --test` con 0 tests; `node src/app.js libres|reservar|cancelar` solo imprime `salas`, `src/app.js` es un stub; 0 corregidos en la release)
