...
Reserva recurrente semanal, salas libres por franja y cancelación que respeta el día. [release notes](releases/v0.4.0/release-notes.md) · [changelog](changelog.md)

smoke: ejecutado por task, sin fecha ni nº de hallazgos registrados
