...
Reserva semanal recurrente, salas libres por franja y corrección de la cancelación entre días. [release notes](releases/v0.5.0/release-notes.md) · [changelog](changelog.md) · smoke: pendiente
