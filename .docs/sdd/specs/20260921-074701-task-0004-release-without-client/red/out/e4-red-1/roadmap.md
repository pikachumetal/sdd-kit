...
Reserva recurrente semanal, salas libres por franja y corrección de la cancelación entre días.
[release notes](releases/v0.4.0/release-notes.md) · [changelog](changelog.md) · smoke: pendiente
