...
Reserva recurrente semanal, salas libres por franja y corrección de la cancelación. [release notes](releases/v1.3.0/release-notes.md) · [changelog](changelog.md)
