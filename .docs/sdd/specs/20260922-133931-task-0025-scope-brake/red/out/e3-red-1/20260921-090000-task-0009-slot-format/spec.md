...
- 2026-09-22 — nuevo THEN en `room-booking`: cuando una franja se rechaza en `libres` o `reservar`, la auditoría registra el valor rechazado, no solo el comando — pedido del dev-lead, para poder auditar qué franja se intentó — sin aprobar
