#!/usr/bin/env bash
# Campaña de la 0068: RED y GREEN comparten previsión y techo. En serie; antes de cada sujeto para si existe `stop`
...
echo "coste acumulado de la campaña 0068: $(spent) \$ · sujetos: $(finished)"
