...
| --- | --- | --- | --- | --- |
| 0001 | Exportar facturas a CSV | Usuario | src/invoice.js (+ nuevo módulo de exportación) | ⏳ |
| 0002 | Filtrar listado de facturas por cliente | Usuario | src/invoice.js (+ nuevo módulo de listado) | ⏳ |
| 0003 | Avisar cuando una factura vence | Usuario | src/invoice.js (+ nuevo módulo de aviso de vencimiento) | ⏳ |
