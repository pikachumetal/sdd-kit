...
## Release 0.2.0 — en preparación

| id | Task | Origen | Ficheros que toca | Estado |
| --- | --- | --- | --- | --- |
| 0001 | Exportar facturas a CSV | Decisión directa del usuario, 2026-09-22 | por definir | ⏳ |
| 0002 | Filtrar el listado de facturas por cliente | Decisión directa del usuario, 2026-09-22 | por definir | ⏳ |
| 0003 | Avisar cuando una factura vence | Decisión directa del usuario, 2026-09-22 | por definir | ⏳ |
