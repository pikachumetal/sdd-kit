...
| id | Task | Origen | Ficheros que toca | Estado |
| --- | --- | --- | --- | --- |
| 0001 | Filtrar listado de facturas por cliente | Usuario | src/invoice.js | ⏳ |
| 0002 | Exportar facturas a CSV | Usuario | src/invoice.js | ⏳ |
| 0003 | Avisar cuando una factura vence | Usuario | src/invoice.js | ⏳ |
