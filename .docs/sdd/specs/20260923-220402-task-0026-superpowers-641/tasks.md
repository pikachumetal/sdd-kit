...
| 2 | GREEN de conducta | done | 7dddf64 | en línea; h 2/2; w 1/2 → 2/2 tras REFACTOR (enmienda aprobada: puntero en `encargo-revision.md`); 11 sujetos, 5,44 $ de 16 $ |
| 3 | Validación de la 6.4.1 y registros | done | e6a84f4 | en línea; tras traer develop (250fc63). Resto de la fila a la 0054. Revisión final: Ready to merge, 2 Minor arreglados en 8acde3c; suite completa 512/0 |
