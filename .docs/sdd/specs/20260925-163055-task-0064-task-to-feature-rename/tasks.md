...
| --- | --- | --- | --- | --- |
| 1 | Lectores y plantillas con `feature` | pending | — | |
| 2 | Renombrar las skills y su vocabulario | pending | — | |
| 3 | Migración, docs vivos y guarda | pending | — | |
| 4 | Campaña de enrutado y de migración | pending | — | |

## Verificación por task

- [ ] Task 1 — `Invoke-Pester -Path tests/Get-NextSddId.Tests.ps1, tests/Build-EstimationLog.Tests.ps1, tests/FeatureRename.Tests.ps1, tests/AnchorTemplates.Tests.ps1 -Output Detailed`
- [ ] Task 2 — `Invoke-Pester -Path tests -ExcludeTagFilter Slow -Output Minimal` + `tests/Hook.Tests.ps1`, `tests/Manifests.Tests.ps1`
