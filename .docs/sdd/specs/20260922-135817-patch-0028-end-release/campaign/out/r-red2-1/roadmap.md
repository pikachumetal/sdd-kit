...
Reserva recurrente semanal, salas libres por franja y fix de cancelación. [changelog](changelog.md)

smoke: 2026-09-22 · 0 hallazgos (suite node --test, 3 tests; 0 corregidos en la release)
