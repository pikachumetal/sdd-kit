...
Reserva recurrente semanal, salas libres por franja, fix de cancelación por día. [changelog](changelog.md)

smoke: 2026-09-22 · 0 hallazgos (suite `node --test`; CLI real: `libres`, `reservar --cada-semana`, `cancelar`)
