...
| --- | --- | --- | --- | --- |
| 1 | Campaña RED (E1–E4) | done | pendiente | Fixture Bookline-fn con `funcional/pedidos.md` y spec ligera |
...
| 4 | GREEN + A/B (6 skills) | in_progress | — | Sin GREEN que correr (nada falló); A/B de 22 runs en curso |
