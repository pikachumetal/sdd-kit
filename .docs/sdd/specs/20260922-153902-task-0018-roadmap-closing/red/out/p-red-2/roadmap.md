...
| --- | --- | --- |
| **Sin validación de la entrada de `cancelar`** — `cancelar xyz 10:00` acepta un día que no existe (la parte de `libres` ya se corrigió en [patch 0008](specs/20260919-090000-patch-0008-slot-format/patch.md)) | Medio: un día mal escrito da una respuesta falsa | patch |
...
| 2026-09-19 | [20260919-090000-patch-0008-slot-format](specs/20260919-090000-patch-0008-slot-format/patch.md) | `libres` aceptaba una franja mal escrita |
