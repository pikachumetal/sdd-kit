...
| 0009 | **Aviso por correo al cancelar** — correo de confirmación al cancelar una reserva, igual que el aviso previo ([nota de uso 2026-09-22](feedback/usage-notes.md)) | `src/notify.js`, `src/app.js` | ⏳ |
| 0007 | **Calendario `.ics`** — exportar las reservas propias a un fichero `.ics` e importar reservas desde un `.ics`, con las horas en la zona horaria de Madrid ([nota de uso 2026-09-22](feedback/usage-notes.md)) | `src/ics.js` | ⏳ |
| 0008 | **Recurrencia semanal por número de repeticiones** — terminar la recurrencia tras N repeticiones, además de por fecha de fin ([nota de uso 2026-09-22](feedback/usage-notes.md)) | `src/recurring.js` | ⏳ |
