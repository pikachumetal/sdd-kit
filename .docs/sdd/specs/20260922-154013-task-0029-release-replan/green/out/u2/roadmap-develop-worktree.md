...
| 0009 | **Recurrencia por número de repeticiones** — `parent: 0005`, partida de ella el 2026-09-22: en vez de fecha de fin, poder fijar cuántas veces se repite la reserva semanal (nota de uso 2026-09-22) | `src/recurring.js` | ⏳ |
...
| 0010 | **Aviso por correo al cancelar** — `parent: 0006`, partida de ella el 2026-09-22: al cancelar una reserva, enviar un correo de confirmación, igual que el aviso previo (nota de uso 2026-09-22) | `src/notify.js`, `src/app.js` | ⏳ |
| 0007 | **Calendario `.ics`** — exportar las reservas propias a un fichero `.ics` e importar reservas desde un `.ics`; las horas exportadas llevan la zona horaria de Madrid, para que el calendario del móvil no las desplace (nota de uso 2026-09-22) | `src/ics.js` | ⏳ |
