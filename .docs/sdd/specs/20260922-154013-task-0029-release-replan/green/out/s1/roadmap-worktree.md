...
| 0007 | **Calendario `.ics`** — exportar las reservas propias a un fichero `.ics` e importar reservas desde un `.ics`, con las horas en zona horaria de Madrid | `src/ics.js` | ⏳ |
| 0009 | **Recurrencia por número de repeticiones** — terminar la reserva semanal tras N repeticiones, no solo por fecha de fin (depende de 0005) | `src/recurring.js` | ⏳ |
| 0010 | **Aviso por correo al cancelar** — correo de confirmación al cancelar una reserva, igual que el aviso previo a la reserva (depende de 0006) | `src/notify.js` | ⏳ |
