...
| 0007 | **Calendario `.ics`** — exportar las reservas propias a un fichero `.ics` e importar reservas desde un `.ics`, con las horas en la zona horaria de Madrid (fuente: [usage-notes.md](feedback/usage-notes.md#L7)) | `src/ics.js` | ⏳ |
| 0008 | **Recurrencia por número de repeticiones** — terminar la reserva semanal tras N repeticiones, sin necesidad de fecha de fin (fuente: [usage-notes.md](feedback/usage-notes.md#L5)) | `src/recurring.js` | ⏳ |
| 0009 | **Aviso por correo al cancelar** — correo de confirmación al cancelar una reserva, igual que el aviso previo (fuente: [usage-notes.md](feedback/usage-notes.md#L6)) | `src/notify.js` | 🔒 bloqueada hasta cerrar 0006 (misma rama/fichero) |
