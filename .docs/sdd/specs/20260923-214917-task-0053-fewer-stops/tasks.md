...
| 3 | GREEN | done | 691e60a | en línea; 17/17 (7 escenarios 2/2 y 3 controles), 5,43 $; campaña entera 10,04 $ de un techo de 18 $. Parado el 2026-09-24 a petición del dev-lead («si tienes agentes arrancados, espera pero no arranques más»), tras la primera ronda s1-1…s5-1. s6-1 arrancó después de la petición, porque el hilo paró primero los procesos equivocados y el lanzador siguió vivo; se deja terminar. El resto (s7-1, la segunda ronda y los controles) se lanzó al retomar el 2026-09-24 |

## Verificación por task

- [x] Task 1 — `Invoke-Pester -Path tests -ExcludeTagFilter Slow`
- [x] Task 2 — `Invoke-Pester -Path tests -ExcludeTagFilter Slow`
- [x] Task 3 — campaña GREEN con `red/run.sh` (techo 18 $ compartido con el RED)
