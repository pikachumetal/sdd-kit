...
- **0009** — Validar el formato de la franja horaria (`HH:MM-HH:MM`) en `libres` y `reservar`; una franja mal formada da error y no consulta ni reserva nada. → [ref](specs/20260921-090000-task-0009-slot-format/)
