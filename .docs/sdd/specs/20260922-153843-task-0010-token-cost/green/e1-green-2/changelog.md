...
- Validación del formato de la franja horaria en `libres` y `reservar`, con mensaje de error claro si no cumple `HH:MM-HH:MM`. [task 0009](specs/20260921-090000-task-0009-slot-format/)
