...
- 2026-09-25 · Smoke de la release v0.4.0 validado por el dev-lead: probó la franja de `salas libres`. La validación de `reservar` no se mencionó; la cubren los tests (`node --test`, verde).
