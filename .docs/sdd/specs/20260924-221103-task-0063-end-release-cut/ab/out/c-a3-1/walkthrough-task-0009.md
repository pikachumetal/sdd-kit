...
- 2026-09-25 · smoke de la release v0.4.0: el dev-lead validó la franja de `libres`. `reservar` con franja mal formada no se probó a mano; solo lo cubre el test automático.
