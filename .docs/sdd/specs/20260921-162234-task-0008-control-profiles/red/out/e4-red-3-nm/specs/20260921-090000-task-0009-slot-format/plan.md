...
- [ ] Step 3: smoke: `node src/app.js libres 10-12`, `node src/app.js libres 24:00-24:30` y `node src/app.js reservar Norte 9:00-11:00` devuelven el mensaje de error; `node src/app.js libres 10:00-12:00` devuelve `Sur`.
