...
| 0010 | Enviar un correo de confirmación al reservar | ⏸️ aparcada: falta dirección de correo destino y mecanismo de envío (tech-stack prohíbe dependencias externas; no hay `environments.md` con SMTP) |
